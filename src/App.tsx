    ...
    <div className="App">
      ...
      <section className="app-description section ">
          <div className="section-content">
            <div className="box border border-primary rounded-lg p-12 bg-dark-color">
              <img src={StarsBackground} alt="Stars background" className="bg-stars" />
              <div className="box-content relative mb-8">
      ...
      <section className="main section">
          <div className="flex flex-col gap-4">
            <div className="content">
              <h4 className="main-heading text-center">A grid of character cards will go here.</h4>
            </div>
